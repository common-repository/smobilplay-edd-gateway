...
if (!function_exists('mb_convert_encoding')) {
    function mb_convert_encoding($string, string $to_encoding,  $from_encoding = null) { return p\Mbstring::mb_convert_encoding($string, $to_encoding, $from_encoding); }
}
...
if (!function_exists('mb_detect_encoding')) {
    function mb_detect_encoding(string $string, $encodings = null, bool $strict = false) { return p\Mbstring::mb_detect_encoding($string, $encodings, $strict); }
}
...
if (!function_exists('mb_strpos')) {
    function mb_strpos(string $haystack, string $needle, int $offset = 0, string $encoding = null) { return p\Mbstring::mb_strpos($haystack, $needle, $offset, $encoding); }
}
...
if (!function_exists('mb_stripos')) {
    function mb_stripos(string $haystack, string $needle, int $offset = 0, string $encoding = null){ return p\Mbstring::mb_stripos($haystack, $needle, $offset, $encoding); }
}
if (!function_exists('mb_stristr')) {
    function mb_stristr(string $haystack, string $needle, bool $before_needle = false, string $encoding = null){ return p\Mbstring::mb_stristr($haystack, $needle, $before_needle, $encoding); }
}
if (!function_exists('mb_strrchr')) {
    function mb_strrchr(string $haystack, string $needle, bool $before_needle = false, string $encoding = null){ return p\Mbstring::mb_strrchr($haystack, $needle, $before_needle, $encoding); }
}
if (!function_exists('mb_strrichr')) {
    function mb_strrichr(string $haystack, string $needle, bool $before_needle = false, string $encoding = null) { return p\Mbstring::mb_strrichr($haystack, $needle, $before_needle, $encoding); }
}
if (!function_exists('mb_strripos')) {
    function mb_strripos(string $haystack, string $needle, int $offset = 0, string $encoding = null) { return p\Mbstring::mb_strripos($haystack, $needle, $offset, $encoding); }
}
if (!function_exists('mb_strrpos')) {
    function mb_strrpos(string $haystack, string $needle, int $offset = 0, string $encoding = null){ return p\Mbstring::mb_strrpos($haystack, $needle, $offset, $encoding); }
}
if (!function_exists('mb_strstr')) {
    function mb_strstr(string $haystack, string $needle, bool $before_needle = false, string $encoding = null){ return p\Mbstring::mb_strstr($haystack, $needle, $before_needle, $encoding); }
}
if (!function_exists('mb_get_info')) {
    function mb_get_info(string $type = 'all'){ return p\Mbstring::mb_get_info($type); }
}
...
if (!function_exists('mb_convert_variables')) {
    function mb_convert_variables(string $to_encoding, $from_encoding, mixed &$var, mixed &...$vars) { return p\Mbstring::mb_convert_variables($to_encoding, $from_encoding, $var, ...$vars); }
}

if (!function_exists('mb_ord')) {
    function mb_ord(string $string, string $encoding = null) { return p\Mbstring::mb_ord($string, $encoding); }
}
if (!function_exists('mb_chr')) {
    function mb_chr(int $codepoint, string $encoding = null) { return p\Mbstring::mb_chr($codepoint, $encoding); }
}
